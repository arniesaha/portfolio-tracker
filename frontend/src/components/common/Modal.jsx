  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        >
          {/* Header */}
          <div className="flex items-start gap-4 p-6 border-b border-secondary-100">
            {Icon && (
          ...
          {/* Footer */}
          {footer && (
            <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-secondary-100 bg-secondary-50">
              {footer}
            </div>
          )}
        </div>
      ...
      <div className="text-center">
        ...
        <div className="flex gap-3 justify-center">
          <button
            onClick={onClose}
            disabled={loading}
            className="px-4 py-2.5 bg-secondary-100 text-secondary-700 rounded-lg font-medium hover:bg-secondary-200 transition-colors disabled:opacity-50"
          >
            {cancelText}
          </button>
          <button
            onClick={onConfirm}
            disabled={loading}
            className={`px-4 py-2.5 text-white rounded-lg font-medium transition-colors disabled:opacity-50 ${currentVariant.buttonClass}`}
          >
